class ServersController < ApplicationController
  ...
  def update
    ...
    extra_params += [:send_limit, :recipients_limit, :allow_sender, :log_smtp_data, :outbound_spam_threshold, :message_retention_days, :raw_message_retention_days, :raw_message_retention_size] if current_user.admin?
